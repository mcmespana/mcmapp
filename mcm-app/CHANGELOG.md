...
### Added
- Created `FloatingMusicPlayer` component to play a background playlist in the "Contigo" section.
- Added `expo-av` to dependencies to handle audio playback and hardware controls.
