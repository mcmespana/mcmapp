    ...
    <BottomSheet visible={visible} onClose={handleClose}>
      ...
      {songTitle && (
        <Text style={[styles.songInfo, { color: theme.icon }]}>
          Reportando fallitos en: &ldquo;{songTitle}&rdquo;
        </Text>
      )}
      ...
      <Text style={[styles.disclaimer, { color: theme.icon }]}>
        Tu reporte nos ayuda a mejorar la calidad del cantoral. Incluye detalles
        como acordes incorrectos, letras con errores o problemas de formato.
      </Text>
    </BottomSheet>
  );
}
