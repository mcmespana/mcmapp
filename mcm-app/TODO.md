...
- [ ] **Comprobar en la primera PR** que aparece el check `PR / verify` y sale
      en verde. Si volviera a no ejecutarse nada, lo PRIMERO que hay que mirar
      es el estado del workflow (Actions → PR → "..." → Enable workflow), no el
      disparador.
