    ...
    const fetchData = async () => {
      try {
        ...
        if (statsSnap.exists()) {
          ...
          // ⚡ Bolt: Avoid Object.entries.map/reduce on unbounded Firebase collections to prevent
          // O(N) intermediate array allocations and excessive Garbage Collection.
          // Use native for...in loops for maximum performance.
          ...
          // ⚡ Bolt: Prefer slice().sort() over [...array].sort() for slightly less overhead
