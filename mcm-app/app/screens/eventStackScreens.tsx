  ...
  ({ route }: { route: EventScreenRoute }) => {
    ...
    if (useFloating) {
      ...
      return {
        ...
        // Fondo OPACO del color de pantalla que RESERVA espacio. Las pantallas de
        // evento tienen el hero/selector FUERA del scroll y wrappers
        // (PageContainer/SafeAreaView) que no auto-insetan fiable bajo un header
        // transparente → se solapaban. Se mantiene opaco (estable).
