# 🗄️ ARCHIVADO — auditoría `/improve` del 2026-08-05

> # ⛔ Los 15 planes de esta carpeta están HECHOS y en `main`.
> # No los ejecutes. No los "revises por si acaso".
>
...
>
> Esta carpeta vivía en `plans/`, en la raíz del repo, donde parecía trabajo
> pendiente. Se movió aquí el 2026-08-15 justo por eso. El índice de planes
> vivos es [`docs/planes/README.md`](../../README.md); el orden de ejecución lo
> manda [`BACKLOG.md`](../../BACKLOG.md).
>
> **Por qué tanto aviso:** ya pasó. Dos sesiones ejecutaron estos mismos 15
> planes en paralelo sin saberlo, y la segunda rama hubo que tirarla
...
Generado por la skill `improve` el 2026-08-05, en el commit `40c6566` (main,
tras el merge de la PR #313). Se conserva como registro del razonamiento de
cada arreglo: lo que se conserva es el **porqué**, no una lista de tareas.

> **Relación con `docs/planes/`**: este directorio fue la salida de una
> auditoría puntual (skill `improve`), NO sustituye a `BACKLOG.md`. La
> auditoría excluyó a propósito todo lo ya planificado allí (PLAN_CALIDAD,
> Integración D, Widget, Carismochito…) y toda la categoría de seguridad.
