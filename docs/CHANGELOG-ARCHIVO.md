# Changelog — MCM App · Archivo (hasta abril de 2026)

> Entradas históricas del changelog, archivadas para mantener ligero
> `mcm-app/CHANGELOG.md` (donde siguen registrándose los cambios nuevos).
